...
```sh
## web1 namespace에 배포 
k apply -f lec5/nginx.yaml -n web1
```
...
```sh
## web2 namespace에 배포 
k apply -f lec5/httpd.yaml -n web2
```
## ingress-rule
...
k apply -f lec5/web1-ing.yaml -n web1

curl http://nginx.{server-ip}.sslip.io
```
...
```
```sh
k apply -f lec5/web2-ing.yaml -n web2

curl http://apache.{server-ip}.sslip.io
```
...
k apply -f lec5/configmap-example.yaml -n web1
...
k apply -f lec5/secret-example.yaml 
...
```sh
## 기존 mysql를 삭제한다 
k delete -f lec5/secret-example.yaml

k apply -f lec5/secret-example2.yaml
...
# clear 
```sh
k delete -f lec5/configmap-example.yaml -n web1
k delete -f lec5/httpd.yaml -n web2
k delete -f lec5/secret-example2.yaml
```
